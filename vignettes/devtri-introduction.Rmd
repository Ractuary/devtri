...
We will be working with the `tri_data` data set which comes with the `devtri` package.  This data is just an ordinary data frame with 3 columns and 21 rows.  Here is the entire data set:
...
Trinagles in the form shown above will not be used in any of the development functions, but they are convenient for viewing and presenting.  We will talk more about presentation later.
